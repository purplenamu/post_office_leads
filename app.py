...
st.caption("행정안전부 자치단체코드(사상구 3390000) 직통 정밀 연동 시스템")

# 1. 5대 핵심 업종 API 엔드포인트
API_URL_MAP = {
...
# 2. 공식 엑셀 기반 부울경 핵심 자치단체 코드 매핑
LOCAL_GOV_CODES = {
    # --- 부산광역시 (16개 구·군) ---
    "부산 사상구 (3390000)": "3390000",
    "부산 강서구 (3360000)": "3360000",
    "부산 북구 (3320000)": "3320000",
    "부산 사하구 (3340000)": "3340000",
    "부산 부산진구 (3290000)": "3290000",
    "부산 동구 (3270000)": "3270000",
    "부산 남구 (3310000)": "3310000",
    "부산 중구 (3250000)": "3250000",
    "부산 서구 (3260000)": "3260000",
    "부산 영도구 (3280000)": "3280000",
    "부산 동래구 (3300000)": "3300000",
    "부산 금정구 (3350000)": "3350000",
    "부산 연제구 (3370000)": "3370000",
    "부산 수영구 (3380000)": "3380000",
    "부산 해운대구 (3330000)": "3330000",
    "부산 기장군 (3400000)": "3400000",
    "부산광역시 전체 (6260000_ALL)": "6260000_ALL",

    # --- 울산광역시 (5개 구·군) ---
    "울산 남구 (3700000)": "3700000",
    "울산 중구 (3690000)": "3690000",
    "울산 동구 (3710000)": "3710000",
    "울산 북구 (3720000)": "3720000",
    "울산 울주군 (3730000)": "3730000",
    "울산광역시 전체 (6310000_ALL)": "6310000_ALL",

    # --- 경상남도 (18개 시·군) ---
    "경남 창원시 (5670000)": "5670000",
    "경남 김해시 (5350000)": "5350000",
    "경남 양산시 (5380000)": "5380000",
    "경남 진주시 (5310000)": "5310000",
    "경남 거제시 (5370000)": "5370000",
    "경남 통영시 (5330000)": "5330000",
    "경남 사천시 (5340000)": "5340000",
    "경남 밀양시 (5360000)": "5360000",
    "경남 함안군 (5400000)": "5400000",
    "경남 거창군 (5470000)": "5470000",
    "경남 창녕군 (5410000)": "5410000",
    "경남 고성군 (5420000)": "5420000",
    "경남 하동군 (5440000)": "5440000",
    "경남 합천군 (5480000)": "5480000",
    "경남 남해군 (5430000)": "5430000",
    "경남 함양군 (5460000)": "5460000",
    "경남 산청군 (5450000)": "5450000",
    "경남 의령군 (5390000)": "5390000",
    "경상남도 전체 (6480000_ALL)": "6480000_ALL"
}
...
with st.sidebar:
    ...
    sigungu_choice = st.selectbox("관할 시·군·구 선택", list(region_hierarchy[sido_choice].keys()), index=0)
    
    target_code = region_hierarchy[sido_choice][sigungu_choice]
...
def fetch_target_localdata(api_key, industry_name, gov_code, active_only, num_rows):
    ...
    params = {
        ...
        "resultType": "json",
        "opnAtmyGrpCd": gov_code  # 핵심: 자치단체코드 서버 파라미터 전달
    }
...
def process_dataframe(df, active_only):
    ...
    # 최신 인허가일자 내림차순 정렬 (신규 설립 의원이 맨 위로)
...
if user_api_key:
    ...
    if err_msg:
        ...
        # 상단 요약 카드
        region_clean_name = selected_region_name.split(" ")[1]
        ...
        st.subheader(f"📋 {selected_region_name} {selected_industry} 실시간 명부 ({len(df)}건 확보)")
